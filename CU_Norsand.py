...
# Norsand input
gamma = 1.22  # [0.9 - 1.4] 'altitude of CSL @ 1kPa'
lambda_val = 0.06  # [0.01 - 0.07] 'slope CSL defined on natural log'
M_tc = 1.45  # [1.2 - 1.5] 'critical state friction ratio triaxial compression'
N = 0.5  # [0.2 - 0.5] 'volumetric coupling coefficient'
H = 90.0  # [25 - 500] 'plastic hardening modulus for loading'
Xim_tc = 5.0  # [2 - 5] 'relates maximum dilatancy to state variable (psi)'
Ir = 600.0  # [100 - 600] 'shear rigidity'
nu = 0.15  # [0.1 0.3] 'Poissons ratio'

# CU input
p0 = 200.0  # [kPa] 'inital pressure'
e0 = 0.902  # [-] 'init void ratio'
eqp_tot = 20.0  # [%] 'total applied plastic deviatoric strain'
